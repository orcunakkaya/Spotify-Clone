...
export const PlayerProvider = ({ children }) => {
    ...
    const playSong = async (trackUri, access_token, deviceId) => {
        ...
        setIsPlaying(true);
        console.log('buraqsi play song fonksiyonu');
      };
      

    return (
        <PlayerContext.Provider value={{ player, setPlayer, currentTrack, setCurrentTrack, isPlaying, setIsPlaying, playSong, setAllTracks, allTracks }}>
            {children}
